...
void change_mininmal_elements_in_columns(int matrix[100][100], int n, int value); // Изменяю элементы в колонне на нужные
int find_maximal_primal(int matrix[100][100], int n); // Найти максимальное простое число.
